...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            rename_project_profile,
            get_projects_referencing_profile,
            attach_profile_to_project,
            detach_profile_from_project,
            ...
            rename_mcp_server_config,
            check_mcp_server_status,
            check_mcp_command_available,
            search_discover_mcp,
            search_collections,
            get_global_mcp_state,
            list_global_eligible_mcp_servers,
            preview_global_mcp_apply,
            set_global_mcp_servers,
            reapply_global_mcp,
            ...
            write_context_documentation_page,
            delete_context_documentation_page,
            move_context_documentation_page,
            list_context_sources,
            list_context_source_entries,
            read_context_source_entry,
